...
### Heya - Here You Art
  ...
  **Head of Products** | 2025 | [Company Link](https://hereyouart.com/)                                                                          
  ...
  - Audit complet du projet : dette technique, priorités et potentiel marché
  - Reconçu et livré un **MVP de A à Z** pour une communauté professionnelle d'artistes belges (profils, réseau, messagerie, offres d'emploi,
  multilingue fr/nl/en)                                                                                                                        
  - Livré un **plan stratégique** structurant la roadmap produit sur 24 mois (acquisition, rétention, monétisation)
  - Identifié et évalué les **opportunités d'intégration LLM open source** (Llama, Mistral) pour l'enrichissement de profils, la recommandation  
  et la modération, dans le respect du RGPD
...
### Développement **carbon:edge-device**
